...
\maketitle
\section{前言}
我写了一个计算的软件, 使用的是python+sagemath. 但是我以为是个小程序, 没想到越写越多, 并没有写注释. 程序入口是bn\_calc.sage.

代码已上传github: \url{ https://github.com/ucas19/sage_for_character }
\section{举例}
...
\begin{equation*}
  ...
  +p_{\tau_2w_0,\sigma w_0 }(1)M_{\tau_1 \lambda'}
  +p_{\tau_3w_0,\sigma w_0 }(1)M_{\tau_1 \lambda'} 
  +p_{\tau_4w_0,\sigma w_0 }(1)M_{\tau_1 \lambda'} \\
  &+p_{\tau_5w_0,\sigma w_0 }(1)M_{\tau_1 \lambda'}
  +p_{\tau_6w_0,\sigma w_0 }(1)M_{\tau_1 \lambda'}
  +p_{\tau_7w_0,\sigma w_0 }(1)M_{\tau_1 \lambda'} \\
 =&M_{\tau_1 \lambda'}
