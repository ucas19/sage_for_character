...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_8 = Integer(8); _sage_const_4 = Integer(4); _sage_const_5 = Integer(5); _sage_const_6 = Integer(6); _sage_const_7 = Integer(7); _sage_const_9 = Integer(9); _sage_const_10 = Integer(10)
...
#            print(f"写入文件P共{len(test)}个向量")
 ...
 #               f.write("\n".join(P_mu_tensor_V_after_Pr))  # 每个元素一行
    ...
    print(f"现在计算{again_lam}------------------")
    lambda_judge_hash, lambda_judge = judge_mu_in_P(again_lam,_sage_const_2 ,_sage_const_1 ,_sage_const_8 )
    for v in weight_set:
        v_hash = tuple(v)
        if v_hash not in lambda_judge_hash:
            print(f"{v}不能判断是否在里面")
