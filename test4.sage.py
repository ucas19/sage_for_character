...
# 定义向量
key1 = vector(QQ, [_sage_const_1 , _sage_const_2 , _sage_const_3 ])
group1 = [
    vector(QQ, [_sage_const_1 , _sage_const_0 ]),
    vector(QQ, [_sage_const_0 , _sage_const_1 , _sage_const_1 /_sage_const_2 ])
]
