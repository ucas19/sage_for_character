    ...
    def remove_matches(front, back):
        ...
        for x in list(front_ctr.keys()):
            ...
            if match_found is not None:
                ...
                removed_count += _sage_const_2  * min_pair
                if front_ctr[x] == _sage_const_0 :
                    del front_ctr[x]
                if back_ctr[match_found] == _sage_const_0 :
...
if __name__ == "__main__":
    ...
    a,b,c = remove_matches([-_sage_const_1 ,-_sage_const_1 ,_sage_const_1 ,_sage_const_1 ,_sage_const_1 ],[_sage_const_1 ,_sage_const_1 ,_sage_const_1 ,-_sage_const_1 ,-_sage_const_1 ])
    print(a)
    print(b)
    print(c)
